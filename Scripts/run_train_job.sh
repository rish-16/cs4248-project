...
export SBATCH_WHICHNODES_EXCLUDE="amdgpu1,xgpc[5-6],xgpd[5-7],xgpf[6-8],xgpg[3-4,6-7],xcne[2-5],xgpc7,xcna[4-6,8-11],xcnb[5-14],xcnc[13-15,17-32,34-37],xcnd[15-44],xgpc[3-4],xgpd[3-4],xgpe[3-8],xgpf[3-5],amdgpu2,xgpg5"
export SBATCH_NODES=1
export SBATCH_TASKS=1
export SBATCH_MEM_PER_NODE="4G"
export SBATCH_TIME_LIMIT="01:30:00"

mkdir "backup/$SBATCH_JOB_NAME"
export SBATCH_OUTPUT="backup/$SBATCH_JOB_NAME/output.slurmlog"
export SBATCH_ERROR="backup/$SBATCH_JOB_NAME/error.slurmlog"
export PROGRAM_OUTPUT="backup/$SBATCH_JOB_NAME/output.slurmlog"
